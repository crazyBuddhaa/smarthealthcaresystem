/* =============================================
   EKSU Smart Health Centre Management System
...
// In production, this would call the EKSU payment portal API
const VALID_PAYMENT_PREFIXES = ['EKSU', 'EKS', 'RRR', 'REMITA'];
function validatePaymentRef(ref) {
  if (!ref || ref.trim().length < 6) return false;
  const upper = ref.trim().toUpperCase();
  // Accept any ref starting with known EKSU/Remita prefixes, or any 10+ digit number
...
function seedData() {
  ...
  const patients = [
    { id:1, matric:'EKS/2021/0012', name:'Oluwaseun Adeyemi', gender:'Male',   dob:'2002-04-15', dept:'Computer Science',   phone:'08012345678', blood:'O+', allergies:'None', address:'Hall 3, EKSU' },
    { id:2, matric:'EKS/2020/0089', name:'Amaka Okonkwo',     gender:'Female', dob:'2001-07-22', dept:'Biochemistry',        phone:'08087654321', blood:'A+', allergies:'Penicillin', address:'Off Campus, Ado-Ekiti' },
    { id:3, matric:'EKS/2022/0234', name:'Babatunde Olatunji',gender:'Male',   dob:'2003-01-09', dept:'Mechanical Eng.',     phone:'07055551234', blood:'B-', allergies:'None', address:'Hall 1, EKSU' },
    { id:4, matric:'EKS/2021/0310', name:'Fatima Bello',      gender:'Female', dob:'2002-11-30', dept:'Law',                 phone:'09033334444', blood:'AB+',allergies:'Aspirin', address:'Hall 5, EKSU' },
    { id:5, matric:'EKS/2020/0055', name:'Chukwuemeka Eze',   gender:'Male',   dob:'2001-08-18', dept:'Accounting',          phone:'08099887766', blood:'O-', allergies:'None', address:'Off Campus, Iyin Rd' },
    { id:6, matric:'EKS/2023/0078', name:'Ngozi Obi',         gender:'Female', dob:'2003-05-14', dept:'Nursing Science',     phone:'08177776655', blood:'A-', allergies:'Latex', address:'Hall 2, EKSU' },
  ];
  ...
  const queue = [
    { id:1, patientId:1, name:'Oluwaseun Adeyemi', matric:'EKS/2021/0012', dept:'Computer Science', time:'08:30', status:'done',    token:'001' },
    { id:2, patientId:2, name:'Amaka Okonkwo',     matric:'EKS/2020/0089', dept:'Biochemistry',     time:'08:45', status:'active',  token:'002' },
    { id:3, patientId:5, name:'Chukwuemeka Eze',   matric:'EKS/2020/0055', dept:'Accounting',       time:'09:00', status:'waiting', token:'003' },
    { id:4, patientId:6, name:'Ngozi Obi',         matric:'EKS/2023/0078', dept:'Nursing Science',  time:'09:15', status:'waiting', token:'004' },
    { id:5, patientId:3, name:'Babatunde Olatunji',matric:'EKS/2022/0234', dept:'Mechanical Eng.',  time:'09:30', status:'waiting', token:'005' },
  ];

  const bills = [
    { id:1, patientId:1, matric:'EKS/2021/0012', name:'Oluwaseun Adeyemi', date:'2025-06-10', items:[{desc:'Consultation',amount:500},{desc:'Malaria Test',amount:1500},{desc:'Drugs',amount:2000}], total:4000, status:'paid',    ref:'RCP001' },
    { id:2, patientId:2, matric:'EKS/2020/0089', name:'Amaka Okonkwo',     date:'2025-06-12', items:[{desc:'Consultation',amount:500},{desc:'Drugs',amount:1200}],                                    total:1700, status:'paid',    ref:'RCP002' },
    { id:3, patientId:3, matric:'EKS/2022/0234', name:'Babatunde Olatunji',date:'2025-06-15', items:[{desc:'Consultation',amount:500},{desc:'Drugs',amount:2500}],                                    total:3000, status:'pending', ref:'' },
    { id:4, patientId:5, matric:'EKS/2020/0055', name:'Chukwuemeka Eze',   date:'2025-07-01', items:[{desc:'Consultation',amount:500},{desc:'Lab Test',amount:3000}],                                 total:3500, status:'pending', ref:'' },
  ];

  const appointments = [
    { id:1, patientId:1, matric:'EKS/2021/0012', name:'Oluwaseun Adeyemi', dept:'Computer Science', date:'2026-08-10', time:'09:00', reason:'General Check-up', status:'confirmed',  paymentRef:'EKSU2026001', cardNo:'HC-2021-0012' },
    { id:2, patientId:2, matric:'EKS/2020/0089', name:'Amaka Okonkwo',     dept:'Biochemistry',     date:'2026-08-10', time:'09:30', reason:'Blood Test',       status:'confirmed',  paymentRef:'EKSU2026002', cardNo:'HC-2020-0089' },
    { id:3, patientId:5, matric:'EKS/2020/0055', name:'Chukwuemeka Eze',   dept:'Accounting',       date:'2026-08-11', time:'10:00', reason:'Eye Test',         status:'pending',    paymentRef:'EKSU2026003', cardNo:'HC-2020-0055' },
    { id:4, patientId:6, matric:'EKS/2023/0078', name:'Ngozi Obi',         dept:'Nursing Science',  date:'2026-08-12', time:'11:00', reason:'General Check-up', status:'pending',    paymentRef:'EKSU2026004', cardNo:'HC-2023-0078' },
  ];
